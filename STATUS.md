...
<!-- AUTO:UPDATED:START -->
_Last updated: **2026-05-10 18:15 UTC** · branch `main`_
<!-- AUTO:UPDATED:END -->
...
<!-- AUTO:COMMITS:START -->
- 559329c feat(mapa): radar scope look — range rings, cardinals, sweep arm _(19 minutes ago)_
- 4527a2d fix(mapa): pulse fills the radar + solid radar border _(25 minutes ago)_
- d39243c fix(flags): SVG flags with proper bounds, no escaping sun _(36 minutes ago)_
- f8fb9c8 feat(forms+ux): forgot pwd, signup confirm, error.tsx, perfil cleanup _(57 minutes ago)_
- 55121af feat(chat+match): selection handoff, textarea, 0-star rate, day labels _(62 minutes ago)_
- 1bfea47 feat(onboarding): stepper, back button, real location flow, inline alias _(67 minutes ago)_
- 67cf293 feat(album): real Search header + AddCromoSheet replaces window.prompt _(70 minutes ago)_
- 87e28a7 refactor(design): shared color tokens, IconBtn primitive, drop hex literals _(72 minutes ago)_
- 73f72b6 feat(a11y+responsive): unblock zoom, dynamic html lang, sidebar at md+ _(76 minutes ago)_
