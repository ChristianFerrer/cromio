...
<!-- AUTO:UPDATED:START -->
_Last updated: **2026-05-11 11:58 UTC** · branch `claude/setup-cromio-pwa-design-Tnidb`_
<!-- AUTO:UPDATED:END -->
...
<!-- AUTO:COMMITS:START -->
- 37a5f10 feat(chat): surface meeting + rating journey on chat list cards (#35) _(8 minutes ago)_
- 9ffa742 docs(contactos): document why match counts are computed pairwise _(16 minutes ago)_
- ca87214 chore(deploy): retrigger production build (#34) _(44 minutes ago)_
- 74b37eb fix(contactos): compute recibes/entregas pairwise from stickers (#33) _(61 minutes ago)_
- b2de1c9 fix(nav): bottom/side nav no longer slides on route change (#32) _(77 minutes ago)_
- 531b5bf feat(contactos): rename header, show visible name, add album stats per row (#31) _(81 minutes ago)_
- c87f931 feat(admin): expose hard delete in the user detail UI _(2 hours ago)_
- 651175c fix(album): 3-col mobile + responsive desktop + larger +/- targets (#30) _(2 hours ago)_
- 72387b5 fix(album): 4-col grid + bigger type label + flag frame (#29) _(2 hours ago)_
- c63b3ec fix(album): cromo card compact + counter inside the card (#28) _(2 hours ago)_
- 39e0871 feat(album): cromo card layout per mockup (code top-left, flag top-right, type centered) (#27) _(3 hours ago)_
- 10d0d4e fix(album): realign sticker dataset to the real 980-cromo Panini album _(3 hours ago)_
- 0fae7a7 feat(admin): push admins when a new user signs up _(4 hours ago)_
- c1314ab revert: PR #25 cromo card overhaul (#26) _(4 hours ago)_
- 8042475 feat(album): cromo card UX overhaul (social signal + tap-to-detail) (#25) _(4 hours ago)_
<!-- AUTO:COMMITS:END -->
