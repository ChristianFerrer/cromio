...
<!-- AUTO:UPDATED:START -->
_Last updated: **2026-05-12 22:35 UTC** · branch `claude/setup-cromio-pwa-design-Tnidb`_
<!-- AUTO:UPDATED:END -->
...
<!-- AUTO:COMMITS:START -->
- 090d166 fix(trades): refresh router + cromo numbers + clarify 2-step flow _(66 minutes ago)_
- a0e6477 feat(trades): buzón de intercambios con 4 tabs + badge en álbum _(83 minutes ago)_
- 4606b0d fix(layout): bottom nav en flujo normal con flex column h-dvh _(8 hours ago)_
- 972619f fix(bottomnav): anclar al visualViewport para evitar gap en iOS _(9 hours ago)_
- 275cf43 fix: skeleton mapa sin pulse + radar más lento + selección vacía bloquea + sin ★ _(11 hours ago)_
- 337c518 feat: quick wins no-visuales + avatar uniforme verde + nav estable _(11 hours ago)_
- ad57ef5 perf(hooks): cross-navigation cache for user, collection and favourites _(26 hours ago)_
- da43b7f fix(perf,nav): disable view transitions + add skeletons for instant nav _(26 hours ago)_
- ac06e4b feat(match,trade): selection-aware request, chat reuse, compact header _(32 hours ago)_
- b7e8c8b style(match): trade button matches the contacts flag treatment _(33 hours ago)_
- a0f5ae9 style(ui): square radius across buttons + simplify trade button _(33 hours ago)_
- dc3481f fix(chat): strip stale state/meeting/rating UI from chat list _(33 hours ago)_
...
- 37a5f10 feat(chat): surface meeting + rating journey on chat list cards (#35) _(35 hours ago)_
<!-- AUTO:COMMITS:END -->
