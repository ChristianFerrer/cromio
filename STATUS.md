...
<!-- AUTO:UPDATED:START -->
_Last updated: **2026-05-10 17:56 UTC** · branch `main`_
<!-- AUTO:UPDATED:END -->
...
<!-- AUTO:COMMITS:START -->
- 4527a2d fix(mapa): pulse fills the radar + solid radar border _(6 minutes ago)_
- d39243c fix(flags): SVG flags with proper bounds, no escaping sun _(17 minutes ago)_
- f8fb9c8 feat(forms+ux): forgot pwd, signup confirm, error.tsx, perfil cleanup _(39 minutes ago)_
- 55121af feat(chat+match): selection handoff, textarea, 0-star rate, day labels _(43 minutes ago)_
- 1bfea47 feat(onboarding): stepper, back button, real location flow, inline alias _(48 minutes ago)_
- 67cf293 feat(album): real Search header + AddCromoSheet replaces window.prompt _(51 minutes ago)_
- 87e28a7 refactor(design): shared color tokens, IconBtn primitive, drop hex literals _(53 minutes ago)_
- 73f72b6 feat(a11y+responsive): unblock zoom, dynamic html lang, sidebar at md+ _(57 minutes ago)_
