...
<!-- AUTO:UPDATED:START -->
_Last updated: **2026-05-12 23:44 UTC** · branch `claude/setup-cromio-pwa-design-Tnidb`_
<!-- AUTO:UPDATED:END -->
...
<!-- AUTO:COMMITS:START -->
- de030a0 fix(ui): nav más compacta (cap safe-area), radio dropdown chico, mapa fit con whenReady + 5px padding _(16 minutes ago)_
- f5d7127 fix(ui): nav compact + radar popup banner + radius dropdown + 2% map padding _(32 minutes ago)_
- d2b5436 fix(ui): 8 ajustes — nav verde+anclado, mapa con header y auto-fit, onboarding radar, badges intercambio activo _(68 minutes ago)_
...
- dc3481f fix(chat): strip stale state/meeting/rating UI from chat list _(35 hours ago)_
<!-- AUTO:COMMITS:END -->
