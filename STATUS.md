...
<!-- AUTO:UPDATED:START -->
_Last updated: **2026-05-11 00:17 UTC** · branch `claude/review-project-setup-51FCV`_
<!-- AUTO:UPDATED:END -->
...
<!-- AUTO:COMMITS:START -->
- 2529b7d feat(chat): richer list cards + fix iOS input zoom (#9) _(6 minutes ago)_
- 06af235 feat(onboarding): simplify to 2 steps — location + identity only _(14 minutes ago)_
- fb580fe feat(design): bump palette to vivid accents (#8) _(26 minutes ago)_
- 48b25ec style(mapa): locate button matches the top-right toolbar, sits clearly above radius card _(47 minutes ago)_
- 5835256 chore(deploy): trigger rebuild for VAPID env vars (#7) _(64 minutes ago)_
- 486d13f fix(ux): useFavorites no longer flashes loaded=true while auth resolves _(73 minutes ago)_
- 8286204 feat(push): nearby-match server-side trigger + iOS hint + diagnostics (#6) _(77 minutes ago)_
