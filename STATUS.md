...
<!-- AUTO:UPDATED:START -->
_Last updated: **2026-05-11 14:20 UTC** · branch `main`_
<!-- AUTO:UPDATED:END -->
...
<!-- AUTO:COMMITS:START -->
- b7e8c8b style(match): trade button matches the contacts flag treatment _(20 minutes ago)_
- a0f5ae9 style(ui): square radius across buttons + simplify trade button _(44 minutes ago)_
- dc3481f fix(chat): strip stale state/meeting/rating UI from chat list _(72 minutes ago)_
- b786ca7 feat(trades): trade requests replace meeting/rating, chat is now pure _(84 minutes ago)_
- 5f34238 chore(deploy): retrigger production build for chat journey UI _(2 hours ago)_
- 37a5f10 feat(chat): surface meeting + rating journey on chat list cards (#35) _(3 hours ago)_
- 9ffa742 docs(contactos): document why match counts are computed pairwise _(3 hours ago)_
...
- b2de1c9 fix(nav): bottom/side nav no longer slides on route change (#32) _(4 hours ago)_
- 531b5bf feat(contactos): rename header, show visible name, add album stats per row (#31) _(4 hours ago)_
...
- c63b3ec fix(album): cromo card compact + counter inside the card (#28) _(5 hours ago)_
<!-- AUTO:COMMITS:END -->
