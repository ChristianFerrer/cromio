...
<!-- AUTO:UPDATED:START -->
_Last updated: **2026-05-16 22:50 UTC** · branch `claude/setup-cromio-pwa-design-Tnidb`_
<!-- AUTO:UPDATED:END -->
...
<!-- AUTO:COMMITS:START -->
- 85e2477 fix(brand): logo Radar 20% más grande en todos los contenedores _(13 minutes ago)_
- ec6d0b8 feat(brand): lucide Radar como logo de Cromio en toda la app + iconos PWA _(60 minutes ago)_
- be29925 fix(header): logo cabecera usa el icono Radar de lucide _(66 minutes ago)_
- a755c73 fix(ui): compartir solo card verde + logo cabecera usa icon.svg _(70 minutes ago)_
- 6e43cc6 feat(ui): PageHeader sticky compartido + tuerca → /perfil + bg verde en compartir + Perfil fuera del bottomNav _(79 minutes ago)_
- d4ad3e7 feat(share): página /compartir + tab Compartir en bottomNav _(2 hours ago)_
- beedf25 fix(bottomnav): vuelve a layout vertical (icono arriba, label debajo) _(3 hours ago)_
- 36ac9d3 feat(bottomnav): layout horizontal — icono + label lado a lado, sizes mayores _(4 hours ago)_
- 6af2c4b fix(map): zoomSnap 0 para fit exacto del radar al viewport _(4 hours ago)_
- a235d72 fix(map): padding 0 en fitBounds — radar pegado a los laterales _(5 hours ago)_
