  ...
  return (
    <main className="px-5 pb-6 pt-14">
      ...
      <section className="mt-5 flex flex-col items-center">
        ...
        <h2 className="mt-3 font-display text-2xl">tu_alias</h2>
        <p className="text-sm text-text-2">Eixample, Barcelona</p>
      </section>
      ...
      <button className="mt-5 flex w-full items-center justify-center gap-2 py-3 text-sm font-semibold text-text-2">
